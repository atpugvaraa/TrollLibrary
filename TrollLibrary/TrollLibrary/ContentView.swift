...
struct ContentView: View {
    ...
    let collection = [
        ...
        AppModel(icons: "AirTroller", name: "AirTroller", developer: "sourcelocation", url: "apple-magnifier://install?url=https://github.com/atpugvaraa/AppLibrary/releases/download/v1.0.0/AirTroller-1.1.1.tipa"),
        
        AppModel(icons: "AppsManager", name: "AppsManager", developer: "TigiSoftware", url: "apple-magnifier://install?url=https://github.com/atpugvaraa/AppLibrary/releases/download/v1.0.0/AppsManager_1.8.4.ipa"),
        
        AppModel(icons: "DebtoIpa", name: "DebToiPA", developer: "sourcelocation", url: "apple-magnifier://install?url=https://github.com/atpugvaraa/AppLibrary/releases/download/v1.0.0/DebToIPA-1.1.1.ipa"),
        
        AppModel(icons: "Discord", name: "Enmity", developer: "Enmity Team", url: "apple-magnifier://install?url=https://github.com/atpugvaraa/AppLibrary/releases/download/v1.0.0/Enmity.ipa"),
        
        AppModel(icons: "E-Sign", name: "E-Sign", developer: "", url: "apple-magnifier://install?url=https://github.com/atpugvaraa/AppLibrary/releases/download/v1.0.0/ESign-4.8.2.ipa"),
    ...
    let updates = [
        AppModel(icons: "TrollLibrary", name: "TrollLibrary", developer: "Aarav", url: "apple-magnifier://install?url=")
    ]
...
//        AppModel(icons: "", name: "[PoopER) - App Icon", developer: "", url: "")
    ...
    @AppStorage("gradientStartColor") private var gradientStartColorHex: String = "#FFFFFF" //MARK: Default Color is white
    ...
    var body: some View {
        TabView {
            ...
            .darkLightModeToggle(hasDarkLightModeActivated: $hasDarkModeActivated, style: isAdvancedDarkModeEnabled ? .Effect : .standard)
            .tabItem {
...
//                    }
                    ...
                    Section(header: Text("Settings")) {
                        Button {
                            uiStyleString = (uiStyle == .standard) ? UIStyle.Effect.rawValue : UIStyle.standard.rawValue
                        } label: {
                            Text(uiStyle == .standard ? "3D Effect" : "Standard")
                        }
                        ...
                        Toggle(isAdvancedDarkModeEnabled ? "Disable Light Dark Mode Effect" : "Enable Light Dark Mode Effect", isOn: $isAdvancedDarkModeEnabled)
                    }
                }
            }
            .tabItem {
