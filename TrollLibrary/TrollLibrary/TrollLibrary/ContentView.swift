...
struct ContentView: View {
    ...
    let collection = [
        ...
        AppModel(icons: "Discord", name: "Discord", developer: "Rosiecord", url: "apple-magnifier://install?url=https://github.com/atpugvaraa/AppLibrary/releases/download/v1.0.0/Rosiecord.ipa"),
